...
| Peer verify | Not included — use `@rodit/verify-hola` or API | `npx @rodit/verify-hola` / `POST /api/identity/verify` |
...
Peer verification: use [`@rodit/verify-hola`](../verify-hola/) (`npx @rodit/verify-hola report "HOLA/..."`) or `POST /api/identity/verify`.
...
Peer verification: `npx @rodit/verify-hola report "HOLA/..."` or `POST /api/identity/verify`.
